...
![[https://hub.packtpub.com/wp-content/uploads/2018/03/165-Cover-Image_0.png](https://hub.packtpub.com/wp-content/uploads/2018/03/165-Cover-Image_0.png)](https://cdn-images-1.medium.com/max/2000/1*MskHK7Xnue89n6lL0VqFAw.png)_[https://hub.packtpub.com/wp-content/uploads/2018/03/165-Cover-Image_0.png](https://hub.packtpub.com/wp-content/uploads/2018/03/165-Cover-Image_0.png)_
...
![[https://create-react-app.dev/](https://create-react-app.dev/)](https://cdn-images-1.medium.com/max/3072/1*KpK0DXk0vqyAY6ZS-MgqlA.png)_[https://create-react-app.dev/](https://create-react-app.dev/)_
...
The most popular examples of single page applications you may have seen are websites like [GMail](http://gmail.com) as well as [Twitter](http://twitter.com).

## Gatsby

![[https://www.gatsbyjs.com/](https://www.gatsbyjs.com/)](https://cdn-images-1.medium.com/max/3492/1*VT9UkIoLOFrcYFxJai97zg.png)_[https://www.gatsbyjs.com/](https://www.gatsbyjs.com/)_
...
Popular companies that are building with Gatsby are the [Braun](https://us.braun.com) shaving company, well as the [Impossible Foods](https://www.impossiblefoods.com)’ Brand website.

## Next

![[https://nextjs.org/](https://nextjs.org/)](https://cdn-images-1.medium.com/max/2368/1*oD537dMC5IVjGFhpkCXZ0A.png)_[https://nextjs.org/](https://nextjs.org/)_
...
I actually found Next by mistake, at the very least it was indirect. I was searching the archives of Reddit to find a person who made an app called [TabSaver](https://www.reddit.com/r/iastate/comments/3i5byz/tabsaver_shows_drink_deals_in_ames_now_officially/) my friends and I used in college. I found the TabSaver developer [Lee Robinson](https://leerob.io), and through his [YouTube](https://youtube.com/user/MaStaleee) channel and [free course](https://masteringnextjs.com) on Next, have fallen in love with the technology.

Websites for [TikTok](http://tiktok.com), [Hulu](http://hulu.com), [Twitch](http://twitch.tv) as well as my hometown grocery store, [Hy-Vee](https://www.hy-vee.com) are all built with NextJS.
...
*A JavaScript library for building user interfaces*reactjs.org](https://reactjs.org/docs/create-a-new-react-app.html)
[**Create React App**
*You don't need to learn and configure many build tools. Instant reloads help you focus on development. When it's time to…*create-react-app.dev](https://create-react-app.dev)
[**Gatsby**
*1 Create a complete website in the time it usually takes to build a prototype Build sites with the services you want,…*www.gatsbyjs.com](https://www.gatsbyjs.com)
[**Next.js by Vercel - The React Framework**
*Production grade React applications that scale. The world's leading companies use Next.js by Vercel to build static and…*nextjs.org](https://nextjs.org)
[**Lee Robinson - Developer, writer, creator.**
*Front-end developer, JavaScript enthusiast, and course creator.*www.leerob.io](https://www.leerob.io/)
