...
![[https://www.etechgs.com/functions-tasks-qa-team-call-center/](https://www.etechgs.com/functions-tasks-qa-team-call-center/)](https://cdn-images-1.medium.com/max/2000/1*ReiR7FGz5HYWJzUctMpLiw.png)_[https://www.etechgs.com/functions-tasks-qa-team-call-center/](https://www.etechgs.com/functions-tasks-qa-team-call-center/)_
...
![[https://coding.abel.nu/2012/04/test-and-verification-in-scrum/](https://coding.abel.nu/2012/04/test-and-verification-in-scrum/)](https://cdn-images-1.medium.com/max/2000/1*N1LG6NoTSD34RLMTN92G6w.png)_[https://coding.abel.nu/2012/04/test-and-verification-in-scrum/](https://coding.abel.nu/2012/04/test-and-verification-in-scrum/)_

I quickly sought out sordid places, finding the JavaScript testing world to be something like the Wild West. I stumbled upon and continued to circle back to a gentleman from Utah called [Kent C. Dodds](https://github.com/kentcdodds), who had extensive experience, as well as countless blogs, videos, and open source courses how to test JavaScript and React applications. I quickly took to a couple of Kent’s public repositories of his reputable courses [TestingJavaScript](https://github.com/kentcdodds/react-testing-library-course) and [EpicReact](https://github.com/kentcdodds/testing-react-apps), and sent a very basic unit test to ‘B’ in which my friend replied “looks good enough to me”.
...
I will provide some quick code snippet example that are based off of Kent’s teachings from his [EpicReact — Testing React Apps ](https://github.com/kentcdodds/testing-react-apps)repository that I applied to the application I am currently developing with my friends.
...
*I was just about to start preparing the app we're working on for general availability, which includes solving a lot of…*epicreact.dev](https://epicreact.dev/)
[**Testing JavaScript with Kent C. Dodds**
*by Kent C. Dodds When a user encounters a bug they look like this: 🤬 Bugs grind work to a halt. Bugs cause financial…*testingjavascript.com](https://testingjavascript.com/)
[**kentcdodds - Overview**
*working hard to make the world better with software working hard to make the world better with software Improving the…*github.com](https://github.com/kentcdodds)
[**Testing | Kent C. Dodds**
*Kent C. Dodds testing blog posts*kentcdodds.com](https://kentcdodds.com/blog/?q=testing)
