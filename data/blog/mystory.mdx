...
![A photo of me in front of the family desktop computer in 2006, likely playing RuneScape](https://cdn-images-1.medium.com/max/2000/1*vhlCtwReSzTJgODy4ILdvA.jpeg)_A photo of me in front of the family desktop computer in 2006, likely playing RuneScape_
...
![My lovely fiancé Emily and I after a Valentine’s Day date](https://cdn-images-1.medium.com/max/8064/1*QPRFugis-Vfv_ZfjwUt_vQ.jpeg)_My lovely fiancé Emily and I after a Valentine’s Day date_
...
> _1. Start freeCodeCamp’s web development and JS certification courses 2. Enroll in and begin work with Harvard’s CS-50 course 3. Seek out and rank my top choices for in-person coding bootcamps 4. Enroll and start each bootcamp prep course, at least finishing one 5. Apply, interview, and be accepted into a program by July 4th_

I will include an exhaustive list at the end of content creators and other various resources and media that heavily influence this plan of attack.
...
Next, I simultaneously, and in an unorganized fashion, began freeCodeCamp’s JavaScript certificate, as well as App Academy, Flatiron School, and Galvanize’s bootcamp prep programs. I managed to make it through every resource up to, and through the introduction of objects. Each curriculum and coursework walked through basic data types, looping, conditionals, and I found myself lost when comparing each program’s explanation and teaching style of objects.
...
After putting my money where my mouth was, I continued completing a majority of Flatiron’s bootcamp prep, and working through the freeCodeCamp JavaScript materials. For financial and professional reasons, work conflicted with my studies during the months of April and May. COVID was now a thing so naturally Emily and I cancelled our lease and moved into my parents basement. Through the end of May and June I helped my parents finish their basement, adding a living room and bathroom, and worked as much as I could on research and coding problems.
...
_\*\*Additional contributing factors to why I chose Flatiron included the overwhelming and supportive communal feeling I received while onboarding with Maryssa and Gracie. I also learned and loved “Feelings Fridays” which made it a no-brainer for me, as I am an expressive and transparent person. I am unaware if/what support systems exist at the other bootcamps since I did not personally attend them._

![A photo of my family mostly because I miss them, the last time we were all together!](https://cdn-images-1.medium.com/max/8064/1*mphZ3fD-ZQEu_GC13STa5A.jpeg)_A photo of my family mostly because I miss them, the last time we were all together!_
...
![A group of us were able and willing to meet at Central Park for the first, and only time since Flatiron started!](https://cdn-images-1.medium.com/max/8064/1*3YBMHwEnbYDkHt7F-_sUUA.png)_A group of us were able and willing to meet at Central Park for the first, and only time since Flatiron started!_
...
*My experience with a loaded, and somewhat uncomfortable term, any why it doesn’t have to be so bad*medium.com](https://medium.com/swlh/networking-after-coding-bootcamp-afcd0e66a3d5)
...
I have also been able to start a side project with my two best friends, one who is a SCRUM master, and one who is just beginning to learn React with a vanilla JavaScript background. Having the experience of teaching someone what I have learned this far in a team environment, and to be learning from more senior engineers in a more professional environment affirms that I have made the right decision to change my career.
...
[**Gabriel Hicks - Software Engineer - Whimser | LinkedIn**
...
[**gabrielhicks - Overview**
*Software Engineer / Full Stack Developer / NYC. gabrielhicks has 296 repositories available. Follow their code on…*github.com](https://github.com/gabrielhicks)

I am also on [Twitter](http://Gabriel Hicks - Software Engineer | gabrielhicksdev The latest tweets from Gabriel Hicks (gabrielhicksdev) Software Engnieer…www.twitter.com/gabrielhicksdev) feel free to follow me and I will follow back!
